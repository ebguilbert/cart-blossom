package openexpo.magnolia;

import info.magnolia.module.ModuleLifecycle;
import info.magnolia.module.ModuleLifecycleContext;
import info.magnolia.module.blossom.module.BlossomModuleSupport;
import openexpo.magnolia.config.CartBlossomConfiguration;
import openexpo.magnolia.config.BlossomServletConfiguration;

/**
 * This class manages the lifecycle of the cart-blossom module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class CartBlossom extends BlossomModuleSupport implements ModuleLifecycle {

    public void start(ModuleLifecycleContext moduleLifecycleContext) {
        if (moduleLifecycleContext.getPhase() == ModuleLifecycleContext.PHASE_SYSTEM_STARTUP) {

            // Using Spring java config
            super.initRootWebApplicationContext(CartBlossomConfiguration.class);
