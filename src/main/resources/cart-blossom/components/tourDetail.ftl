...
[#assign cartNode = cmsfn.nodeByPath("/travel/footer/footer1/0")]
[#assign tourLink = cmsfn.contentById(tour.identifier,"tours").@path ]
...
<div class="container after-product-header">
    ...
    <div class="row product-info product-summary">
        ...
        [#assign tourPageNode = cmsfn.contentByPath("/travel/tour")]
            <form action="">
                <input type="hidden" name="location" value="${tour.location!}">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product" value="${tour.name!}">
                <input type="hidden" name="url" value="/tours${tourLink}">
                <input type="hidden" name="_pecid" value="${cartNode.getIdentifier()!}">
